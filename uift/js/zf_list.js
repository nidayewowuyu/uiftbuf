            ...
            success:function(d){
                ...
                for(var i=0;i<data.length;i++){
                    htmlStr+=`<li class="clearfloat">
                            <a href="zf_details.html?zfId=${data[i].zfId}" target="_blank">
                                <img src="${data[i].picList[0].zfPic}" alt=""/>
                            </a>
                            <div class="information">
                                <h2><a href="zf_details.html?zfId=${data[i].zfId}" target="_blank">${data[i].title}</a></h2>
                                <p><span>${data[i].houseType}</span><span>${data[i].leaseWay}</span>
                                     <span>${data[i].size}㎡</span><span>${data[i].floor}层</span><span>朝向：${data[i].orientation}</span>
                                </p>
